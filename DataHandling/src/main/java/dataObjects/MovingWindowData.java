...
/**
 * extends generic Data class, creates a dataset of the same dimensions as the raw data but where 
 * previous datapoints (y-1 to y-n) make up an x vector to predict  y value. 
 * remember that dimensions[0] = number of rows and dimensions[1] = number of columns 
 * @author emann06
 *
 */

...
public class IOStringParser{
	...
	/**Takes a io string arraylist and parsers to a double[][] matrix
	 * This does very little error checking - assumes that the file is delimited correctly (no trailing spaces etc)
	 *  
	 * @param ioInput
	 * @param delimiter
	 * @return data a Data object with the data matrix and dimensions info in place
	 */
